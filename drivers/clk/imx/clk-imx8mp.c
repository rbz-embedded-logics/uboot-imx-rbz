...
static int imx8mp_clk_probe(struct udevice *dev)
{
	...
	clk_dm(IMX8MP_CLK_NAND, imx8m_clk_composite(dev, "nand", imx8mp_nand_sels, base + 0xab00));
	...
	clk_dm(IMX8MP_CLK_NAND_ROOT, imx_clk_gate2_shared2(dev, "nand_root_clk", "nand", base + 0x4300, 0, &share_count_nand));
	clk_dm(IMX8MP_CLK_NAND_USDHC_BUS_RAWNAND_CLK, imx_clk_gate2_shared2(dev, "nand_usdhc_rawnand_clk", "nand_usdhc_bus", base + 0x4300, 0, &share_count_nand));
	...
	clk_dm(IMX8MP_CLK_USB_ROOT, imx_clk_gate2_shared2(dev, "usb_root_clk", "hsio_axi", base + 0x44d0, 0, &share_count_usb));
	clk_dm(IMX8MP_CLK_USB_SUSP, imx_clk_gate2_shared2(dev, "usb_suspend_clk", "osc_24m", base + 0x44d0, 0, &share_count_usb));
