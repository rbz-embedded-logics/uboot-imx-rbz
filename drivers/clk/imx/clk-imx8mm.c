...
static const char * const imx8mm_nand_sels[] = {"osc_24m", "sys_pll2_500m", "audio_pll1_out", "sys_pll1_400m",
...
static int imx8mm_clk_probe(struct udevice *dev)
{
	...
	clk_dm(IMX8MM_CLK_NAND,
	       imx8m_clk_composite(dev, "nand", imx8mm_nand_sels, base + 0xab00));
	...
	clk_dm(IMX8MM_CLK_NAND_USDHC_BUS_RAWNAND_CLK,
	       imx_clk_gate2_shared2(dev, "nand_usdhc_rawnand_clk", "nand_usdhc_bus", base + 0x4300, 0, &share_count_nand));
