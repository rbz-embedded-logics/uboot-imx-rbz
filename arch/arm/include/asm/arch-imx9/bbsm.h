...
#define EXT_TAMPER_CONFIG_ALERT_LEVEL EXT_TAMPER_CONFIG_ALERT_LEVEL_2
#else
#define EXT_TAMPER_CONFIG_ALERT_LEVEL EXT_TAMPER_CONFIG_ALERT_LEVEL_1
#endif

#define EXT_TAMPER_CONFIG0 (\
		EXT_TAMPER_CONFIG_PASSIVE_ACTIVE_LOW << 0 | \
		EXT_TAMPER_CONFIG_ALERT_LEVEL << 8 | \
